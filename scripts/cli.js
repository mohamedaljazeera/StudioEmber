...
const contractABI = require("../artifacts/contracts/Studioember.sol/Studioember.json").abi;

program
    .name("studioember-cli")
    .description("CLI tool for Studioember smart contract")
    .version("1.0.0");
