 ...
 * This file demonstrates how to integrate Studioember with a web frontend
 */

// For React/Vue/Angular applications
export class StudioemberClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new StudioemberClient(provider, contractAddress);
